    ...
    return (
        <>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col self-stretch p-6 gap-4 rounded-2xl bg-[#D9D9D9] shadow-xl">
                ...
                <button type="submit" disabled={state === "processing"} className="btn bg-[#02568a] mt-4 font-bold duration-1000 hover:bg-[#3a87b7]">
                    {state === "processing" && (
                    ...
                    {state === "processing" ? "Procesando..." : "Transferir"}
                </button>
            </form>
        </>
    );
